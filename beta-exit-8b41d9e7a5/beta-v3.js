...
const PERFECT={
  ko:{eyebrow:'PERFECT · 26 / 26',top:'축하합니다!',name:'아이돌 수련회 1기 수석 수료증',sub:'26명의 친구들과 모두 수료 완료',message:'당신은 26명의 친구들과 함께 수련회의 모든 여정을 완벽히 마쳤습니다. 모든 추억을 완성한 수련생에게 수석 수료증을 수여합니다.',save:'수석 수료증 저장하기',share:'수석 수료증 자랑하기'},
  en:{eyebrow:'PERFECT EXIT · 26 / 26',top:'Congratulations!',name:'Idol School Camp 1st Honours Certificate',sub:'Completed the exit with all 26 friends',message:'You completed every camp memory together with all 26 friends. This honours certificate is awarded to a true Idol School Camp Master.',save:'Save honours certificate',share:'Share honours certificate'},
  ja:{eyebrow:'PERFECT EXIT · 26 / 26',top:'おめでとうございます！',name:'アイドル修練会1期 首席修了証',sub:'26人全員と退所完了',message:'26人の仲間とともに修練会のすべての思い出を完成させました。アイドル修練会マスターにこの首席修了証を授与します。',save:'首席修了証を保存',share:'首席修了証をシェア'},
  'zh-CN':{eyebrow:'PERFECT EXIT · 26 / 26',top:'恭喜！',name:'偶像修炼会1期 首席结业证书',sub:'与26位朋友全部完成退所',message:'你与26位朋友一起完成了修炼会的全部回忆。特此向真正的偶像修炼会大师颁发这份首席结业证书。',save:'保存首席证书',share:'分享首席证书'},
  'zh-TW':{eyebrow:'PERFECT EXIT · 26 / 26',top:'恭喜！',name:'偶像修煉會1期 首席結業證書',sub:'與26位好友全部完成退所',message:'你與26位好友一起完成了修煉會的全部回憶。特此向真正的偶像修煉會大師頒發這份首席結業證書。',save:'儲存首席證書',share:'分享首席證書'}
};
